...
label_score=font.render("Score: 0",(0,0,0),(255,255,255))
label_rect=label_score.get_rect()
label_rect.center=(60,10)

label_gameover=font.render("GAMEOVER",(0,0,0),(255,0,0))
label_rect_gameover=label_gameover.get_rect()
label_rect_gameover.center=(250,500)

label_restart=font.render("RESTART",(0,0,0),(0,0,255))
...
def main():
    ...
    while run:
        ...
        #if game is not over then it continues
        if game_over==False:
            #Create Delta Time
            new_time=time.time()
            ...
            #Moving the Pipes and checking for out of screeen
